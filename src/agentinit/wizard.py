...
from agentinit import catalog, enrich
from agentinit.config import Commands, Config, Kind, Mode, Modules, Project, Selection
from agentinit.detect import Detection
from agentinit.presets import AUTONOMY, AUTONOMY_SCOPE, LEVELS, default_autonomy, preset, suggested_modules
...
def run(name: str, detection: Detection) -> Config:
    ...
    enrich_pass = (
        ...
        and questionary.confirm(
            "Add a Claude pass that maps the codebase into the generated docs (`agentinit enrich`)?",
